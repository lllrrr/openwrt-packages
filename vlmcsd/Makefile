...
PKG_SOURCE_VERSION:=badb24eabc8081e23d5986fcf1cee8d2a324084f
PKG_MIRROR_HASH:=1e65b9b5ff1cb439022b191f0d3bd41d5506f54c0e754a980d3bedafddbfb4e6
...
define Package/vlmcsd/install
	...
	$(INSTALL_DATA) ./files/vlmcsd.conf $(1)/etc/config/vlmcsd
