...
bypasscore_has_required_features() {
	...
	for feature in control-unix-http-json raw-dns dns-outbound-tag routing-final-outbound runtime-snapshot-reload ready-status inbound-health dns-result-nftset dns-result-nftset-probe tcp-connect-probe outbound-probe wireguard-client wireguard-key-generation wireguard-handshake-probe url-test-resolver-tag; do
