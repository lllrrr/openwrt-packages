...
local function frps_version()
	local file = uci:get("frps", "main", "default_client_file")
...
"<p>%s</p><p>%s</p><p>%s</p>" % {
	translate("Frp 是一个可用于内网穿透的高性能的反向代理应用。多实例模式下，每个 FRPS 实例就是一个独立的 frps 进程。"),
...
o.template = "frps/program_manager"
o.rawhtml = true
...
o = s:taboption("general", Value, "default_client_file", translate("默认可执行文件路径"), frps_version())
o.rmempty = false
o.default = "/usr/bin/frps"
o.description = translate("实例若未指定 client_file，则使用此默认值。可在「程序管理」中下载/切换版本。")
