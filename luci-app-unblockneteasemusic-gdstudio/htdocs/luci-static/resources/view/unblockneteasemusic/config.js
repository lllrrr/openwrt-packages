...
return view.extend({
	...
	render: function(data) {
		...
		m = new form.Map('unblockneteasemusic', _('解除网易云音乐播放限制'),
			_('原理：采用 [Bilibili/JOOX/酷狗/酷我/咪咕/pyncmd/QQ/Youtube/GD Studio] 等音源，替换网易云音乐 无版权/收费 歌曲链接<br/>' +
		...
		o.value('gdstudio', _('GD Studio 音乐'));
		...
		o = s.option(form.Flag, 'enable_flac', _('启用无损音质'),
			_('目前仅支持酷狗、酷我、咪咕、pyncmd、QQ、GD Studio 音源。'));
		o.default = o.disabled;
		...
		o.depends({'music_source': 'qq', '!contains': true});
		o.depends({'music_source': 'gdstudio', '!contains': true});
