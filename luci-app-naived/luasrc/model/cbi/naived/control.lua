...
local escconf = "/etc/naived/white.list"
...
local blockconf = "/etc/naived/black.list"
...
local denydomainconf = "/etc/naived/deny.list"
...
local netflixconf = "/etc/naived/netflix.list"
...
if is_finded("dnsproxy") then
	...
	local dnsproxyconf = "/etc/naived/dnsproxy_dns.list"
...
if luci.sys.call('[ -f "/www/luci-static/resources/uci.js" ]') == 0 then
	...
	function m.on_apply(self)
		luci.sys.call("/etc/init.d/naived reload > /dev/null 2>&1 &")
	end
end
