...
m = Map(appname, "%s - %s" % { translate("SXray"), translate("Subscribe Config") })
m.redirect = api.url("subscribe")
...
o = s:option(Flag, "boot_update", translate("Update Once on Boot"),
	translate("Updates the subscription the first time SXray runs automatically after each system boot."))
o.default = 0
