...
m = Map("sxray", "%s - %s" % { translate("SXray"), translate("Transparent Proxy") })
...
o = s:option(Flag, "enabled", translate("Enabled"), translate("Enable transparent proxy service."))
o.rmempty = false
...
o = s:option(ListValue, "firewall_backend", translate("Firewall Backend"), translate("Choose between iptables and nftables (OpenWrt 24.10+)"))
o:depends("enabled", "1")
o:value("iptables", translate("iptables"))
o:value("nftables", translate("nftables"))
o.default = "iptables"
...
o = s:option(Flag, "redirect_udp", translate("Redirect UDP"), translate("Redirect UDP traffic to SXray."))
o:depends("enabled", "1")

o = s:option(Flag, "redirect_dns", translate("Redirect DNS"), translate("Redirect DNS traffic to SXray."))
o:depends("enabled", "1")
o:depends("redirect_udp", "")
o:depends("redirect_udp", "0")

o = s:option(ListValue, "proxy_mode", translate("Proxy mode"),
	translate("If enabled, firewall rules will be added to pre-filter traffic and then sent to SXray."))
o:depends("enabled", "1")
...
o.rows = 5
o.datatype = "string"
o.filepath = "/etc/sxray/directlist.txt"
o.cfgvalue = sxray.textarea_cfgvalue
o.write = sxray.textarea_write
o.remove = sxray.textarea_remove
o.parse = function(...)
...
o.rows = 3
o.datatype = "string"
o.filepath = "/etc/sxray/srcdirectlist.txt"
o.cfgvalue = sxray.textarea_cfgvalue
o.write = sxray.textarea_write
o.remove = sxray.textarea_remove
o.parse = function(...)
