...
local require_dir = "luci.sxray."

local ipt_bin = sys.exec("echo -n $(/usr/share/sxray/iptables.sh get_ipt_bin)")
local ip6t_bin = sys.exec("echo -n $(/usr/share/sxray/iptables.sh get_ip6t_bin)")
